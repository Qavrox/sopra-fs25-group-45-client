...
| **[@Qavrox]**   | 30.04    | [Link to Commit 1](https://github.com/Qavrox/sopra-fs25-group-45-server/tree/FixDTO) | Fix the bug that block the whole team for a week (took me more than 2 days to locate the problem) | Basic game function |
